...
# source libs
foreach lib_file [glob -directory $env(PETALINUX)/etc/hsm/scripts/libs/ *] {
	source $lib_file
}
...
variable repo_path "$env(PETALINUX)/components/edk_user_repository"
#variable repo_path "./"
variable find_ip_cmd "$env(PETALINUX)/tools/common/petalinux/utils/petalinux-find-ipaddr"
