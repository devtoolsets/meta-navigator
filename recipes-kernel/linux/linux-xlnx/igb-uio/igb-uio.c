...
static int uio_reserved_mem_init(struct reserved_mem *rmem)
{
    pr_info("reserved memory %p, size: %08x\n", rmem->base, rmem->size);
	return 0;
}

RESERVEDMEM_OF_DECLARE(uio_reserved_mem, "uio_reserved_mem", uio_reserved_mem_init);
